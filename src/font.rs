...
impl FontSet {
    pub fn new(description: FontDescription) -> Option<FontSet> {
        unsafe {
            let pattern = description.to_pattern();
    ...
    pub fn render_line_text(
        ...
        for chunk in ChunkIter::new(text, &fontset) {
            ...
            unsafe {
                ...
                let height = cmp::max(fontset.description.pixel_size as i32, ascent);
