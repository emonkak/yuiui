...
use yuiui::{
    ...
    RenderLoopContext, State, StateScope,
};
...
pub(super) enum Action<S: State> {
    RequestRender,
    PushEffect(IdPathBuf, ComponentIndex, StateScope, Effect<S>),
}
